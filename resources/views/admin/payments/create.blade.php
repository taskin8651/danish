    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="title">{{ trans('cruds.payment.fields.title') }}</label>
            ...
            <div class="form-group">
                <label for="upload_file">{{ trans('cruds.payment.fields.upload_file') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.payment.fields.upload_file_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($payment) && $payment->upload_file)
      var file = {!! json_encode($payment->upload_file) !!}
