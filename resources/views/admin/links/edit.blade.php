    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.links.update", [$link->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" name="facebook" id="facebook">{{ old('facebook', $link->facebook) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('instragram') ? 'is-invalid' : '' }}" name="instragram" id="instragram">{{ old('instragram', $link->instragram) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" name="youtube" id="youtube">{{ old('youtube', $link->youtube) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" name="linkedin" id="linkedin">{{ old('linkedin', $link->linkedin) }}</textarea>
