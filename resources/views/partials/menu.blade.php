<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('service_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/service-types*") ? "c-show" : "" }} {{ request()->is("admin/projects*") ? "c-show" : "" }} {{ request()->is("admin/reviews*") ? "c-show" : "" }} {{ request()->is("admin/payments*") ? "c-show" : "" }} {{ request()->is("admin/service-details*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('service_detail_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.service-details.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/service-details") || request()->is("admin/service-details/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.serviceDetail.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @can('website_setup_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/enquiries*") ? "c-show" : "" }} {{ request()->is("admin/contact-details*") ? "c-show" : "" }} {{ request()->is("admin/logos*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
