...
class GalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        $galleries = Gallery::with(['service_type', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.galleries.create', compact('service_types'));
    }
    ...
    public function edit(Gallery $gallery)
    {
        ...
        $gallery->load('service_type');

        return view('admin.galleries.edit', compact('gallery', 'service_types'));
    }
